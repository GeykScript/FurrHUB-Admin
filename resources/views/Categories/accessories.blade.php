    ...
    <div class="bg-white">
        ...
        <div class="md:px-[3rem]  px-2 mt-10">
            <div class="flex flex-row items-center justify-center md:px-10 px-2 mt-5 h-20  rounded-lg bg-gradient-to-r from-orange-600  to-orange-400    ">
                <div class="flex flex-row items-center md:gap-5 gap-1 ">
                    ...
                    <h1 class="md:text-4xl text-md font-bold text-white ">Accessories Category</h1>
                </div>
            </div>
        </div>
        <div class="mt-10 w-full">
            <div class="md:px-20 flex gap-5 items-center px-4  text-sm md:text-lg">
                ...
                <div> > </div>
                <a href="{{route('accessories')}}" class="hover:underline text-orange-500">Accessories Category</a>
            </div>
        </div>
        <div class="md:px-20 md:p-4 rounded-lg mt-5">
            <div class="flex items-center md:justify-start justify-center  gap-3">
                ...
                <button class="text-gray-600 hover:text-orange-600 px-3 py-1">Latest</button>
                <div class="relative">
