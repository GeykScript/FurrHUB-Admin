...
<head>
    ...
    <title>Furr Hub - Add Service</title>
...
<div class="flex h-screen">
            ...
            <div class="p-4">
                ...
                <nav class="font-bold">
                    <ul>
                        ...
                        <li class="mb-2 border border-gray shadow-sm rounded-lg">
                            <a href="{{ route('services_offer') }}" class="block p-3 flex text-lg items-center text-white bg-[#F0A02C] rounded transition duration-200">
                                <svg class="w-10 h-10 pr-2 ml-2" fill="currentColor" viewBox="0 0 20 20" >
    ...
    <main class="flex-1 overflow-y-auto p-6 bg-gray-100">
        ...
        <a href="{{ route('services_offer') }}" class="hover:text-[#F0A02C]">HOME</a>
        <svg class="h-4 w-4 mx-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
        </svg>
        <span class="text-[#F0A02C] text-lg">ADD SERVICE</span>
        </div>
        ...
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-[#F0A02C]">ADD SERVICE</h1>
        </div>
        ...
        <form>
            ...
            <!-- Left Column -->
                <div>
                    ...
                    <div class="mb-4">
                    <label class="block text-gray-700 mb-2">Service Category</label>
                    <div class="relative">
            ...
            <!-- Right Column -->
                <div>
                    ...
                    <button type="button" class="px-6 py-2 border border-gray-300 rounded-md text-yellow-500 hover:bg-gray-50">
                        Cancel
                    </button>
                    <button type="submit" class="px-6 py-2 bg-yellow-500 text-white rounded-md hover:bg-yellow-600">
                        Submit
                    </button>
                    </div>
                </div>
