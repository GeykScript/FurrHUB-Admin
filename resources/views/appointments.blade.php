...
<head>
    ...
    <title>furrHUB - Pet Appointment Dashboard</title>
    ...
    <div class="w-90 bg-white border-r shadow-sm">
        ...
        <nav class="font-bold">
            <ul>
                ...
                <li class="mb-2 border border-gray shadow-sm rounded-lg">
                    <a href="{{ route('services_offer') }}" class="block p-3 flex text-lg items-center text-lg text-black hover:bg-gray-300 rounded transition duration-200">
                        <svg class="w-10 h-10 pr-2 ml-2" fill="currentColor" viewBox="0 0 20 20" >
                ...
                <li class="mb-2 border border-gray shadow-sm rounded-lg">
                    <a href="#" class="block p-3 flex items-center text-lg text-white bg-[#F0A02C] rounded transition duration-200">
