...
<body class="bg-gray-100 flex h-screen">
    <div class="flex h-screen">
            ...
            <div class="p-4">
                ...
                <nav class="font-bold">
                    <ul>
                        ...
                        <li class="mb-2 border border-gray shadow-m rounded-lg">
                            <a href="#" class="block p-3 flex text-lg items-center text-white bg-[#F0A02C] rounded transition duration-200">
                                <svg class="w-10 h-10 pr-2 ml-2" fill="currentColor" viewBox="0 0 20 20" fill="white">
        ...
        <div class="flex-1 bg-gray-50">
                    ...
                    <div class="flex items-center">
                        ...
                        <div x-data="{ open: false }" class="relative ml-4">
                            ...
                            <div x-show="open" @click.outside="open = false"
                                ...
                                <a href="#" class="block px-4 py-2 text-lg text-black hover:bg-gray-300">Log Out</a>
                            </div>
                        </div>
                        </div>
                    </div>
            ...
            <div class="flex-1 overflow-auto p-6 w-[1657px]">
