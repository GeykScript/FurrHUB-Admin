...
<body class="bg-gray-100">
        ...
        <div class="p-4">
          ...
          <nav class="font-bold">
            <ul>
                ...
                <li class="mb-2 border border-gray shadow-sm rounded-lg">
                    <a href="{{ route('services_offer') }}" class="block p-3 flex text-lg items-center text-lg text-white bg-[#F0A02C] rounded transition duration-200">
                        <svg class="w-10 h-10 pr-2 ml-2" fill="currentColor" viewBox="0 0 20 20" >
    ...
    <!-- Main Content -->
      <div class="flex-1 bg-gray-50 overflow-y-auto w-screen">
        <!-- Top Bar -->
        ...
        <div class="flex-1 overflow-auto p-6">
            ...
            <div class="flex items-center text-[#F0A02C] text-2xl font-bold">
          ...
          <div class="flex justify-between mb-4">
            ...
            <div class="flex items-center space-x-2">
              <a href="#" class="flex items-center border rounded-md px-3 py-2 mr-2 text-gray-700">
                <span class="mr-2">Generate Report</span>
                <i class="fas fa-file-export text-blue-500"></i>
              </a>
              
              <a href="{{ route('add-services') }}" class="flex items-center bg-orange-500 text-white rounded-md px-3 py-2">
          ...
          <div class="overflow-x-auto">
            <div class="border border-black rounded-lg">
              <table class="min-w-full border-collapse">
                <thead>
                  <tr>
                    <th class="px-4 py-3 text-left text-m font-bold text-gray-600 border-b">ID</th>
                    <th class="px-4 py-3 text-left text-m font-bold text-gray-600 border-b">Name</th>
                    <th class="px-4 py-3 text-left text-m font-bold text-gray-600 border-b">Category</th>
                    <th class="px-4 py-3 text-left text-m font-bold text-gray-600 border-b">Price</th>
                    <th class="px-4 py-3 text-left text-m font-bold text-gray-600 border-b">Service Provider</th>
                    <th class="px-4 py-3 text-left text-m font-bold text-gray-600 border-b">Description</th>
                    <th class="px-4 py-3 text-left text-m font-bold text-gray-600 border-b">Discount</th>
                    <th class="px-4 py-3 text-left text-m font-bold text-gray-600 border-b">Action</th>
                  </tr>
                </thead>
                <tbody>
                  <tr class="border-b border-gray-200">
                    <td class="px-4 py-3 text-center">1</td>
                    <td class="px-4 py-3">Dog Full Grooming(10kg)</td>
                    <td class="px-4 py-3">Grooming</td>
                    <td class="px-4 py-3">₱600</td>
                    <td class="px-4 py-3">Dr. John Doe</td>
                    <td class="px-4 py-3 text-gray-500">Lorem ipsum dolor sit amet consectetur</td>
                    <td class="px-4 py-3 text-green-500">Available</td>
                    <td class="px-4 py-3">
                      <div class="flex">
                  ...
                  <tr class="border-b border-gray-200">
                    ...
                    <td class="px-4 py-3">Dog Full Grooming(15-20kg)</td>
                    <td class="px-4 py-3">Grooming</td>
                  ...
                  <tr class="border-b border-gray-200">
                    ...
                    <td class="px-4 py-3">Issuance of Health Certificate</td>
                    <td class="px-4 py-3">Wellness & Laboratory</td>
                  ...
                  <tr class="border-b border-gray-200">
                    ...
                    <td class="px-4 py-3">Vaccine 5-in-1</td>
                    <td class="px-4 py-3">Vaccination & Pharmacy</td>
          ...
          <div class="flex justify-end mt-6">
            <button class="flex items-center text-green-500">
              ...
              <span>Restore Deleted Services</span>
            </button>
          </div>
        </div>
      </div>
