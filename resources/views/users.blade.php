...
<head>
    ...
    <title>FurrHUB - Manage Users</title>
</head>
    ...
    <div class="flex h-screen">
            ...
            <div class="p-4">
                ...
                <nav class="font-bold">
                    <ul>
                        ...
                        <li class="mb-2 border border-gray shadow-sm rounded-lg">
                            <a href="{{ route('users.manage') }}" class="block p-3 flex text-lg items-center text-lg text-white bg-[#F0A02C] rounded transition duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="white" class="w-10 h-10 pr-2 ml-2"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="p-6">
                ...
                <div class="bg-white shadow-md mt-4 p-4 rounded-lg">
                    <h1 class="text-2xl font-bold text-[#F0A02C] pb-5">Manage Customer Accounts</h1>
                    <table class="w-full text-left border border-black rounded-full">
                        <thead>
                            <tr class="text-black border-b border-black rounded-lg">
                        ...
                        <tbody>
                            <tr>
                                <td class="p-2"><div class="w-8 h-8 bg-gray-300 rounded-full"></div></td>
                                <td class="p-2">John Doe</td>
                                <td class="p-2">JohnDoe@gmail.com</td>
                                <td class="p-2 text-green-500">● Active</td>
                                <td class="p-2">
                                    <button class="bg-orange-500 text-white py-1 px-3 rounded">Manage</button>
                                </td>
                            </tr>
                            <!-- Repeat above row for multiple users -->
                        </tbody>
                    </table>
                </div>
            </div>
